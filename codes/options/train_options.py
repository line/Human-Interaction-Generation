...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--no_cross_attn', action='store_true', help='whether use efficient attention')
        self.parser.add_argument('--label_model', action='store_true', help='whether use efficient attention')

        self.parser.add_argument('--num_epochs', type=int, default=50, help='Number of epochs')
        self.parser.add_argument('--limit_data_num', type=int, default=-1, help='Muximum number of data')
